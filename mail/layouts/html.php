...
<?php $this->beginBody() ?>
<!-- HEADER -->
<table class="head-wrap" background="<?= $message->embed(Yii::getAlias('@wma/mail/assets/border.png')) ?>">
    <tr>
        <td></td>
        <td class="header container" >
            <div class="content">
                <table>
                    <tr>
                        <td><img src="<?= $message->embed(Yii::getAlias('@wma/assets/img/logo.png')) ?>" height="30" width="142" /></td>
                        <td align="right"><h6 class="collapse"><?= $message->title ?></h6></td>
                    </tr>
                </table>
            </div>
        </td>
